...
export const demoCoasters: DemoCoaster[] = [
  ...
  },
  {
    ...
    friendAverage: 9.1,
    friendRatings: [
      { user: { name: "Maya", avatarUrl: demoUsers[0].avatarUrl }, rank: 2, score: 9.3 },
      { user: { name: "Avery", avatarUrl: demoUsers[2].avatarUrl }, rank: 3, score: 9.1 },
    ],
  },
  {
    name: "Blue Streak",
    ...
    friendAverage: 6.2,
    friendRatings: [
      { user: { name: "Jonah", avatarUrl: demoUsers[1].avatarUrl }, rank: 40, score: 3.2 },
    ],
  },
];
